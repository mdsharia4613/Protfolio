...
">
                ...
                {/* Fronted */}
                <div data-aos="fade-up-left" className="shadow-2xl shadow-gray-400 bg-gray-300 gap-1 p-6 space-y-5 rounded-3xl hover:shadow-4xl  transition hover:duration-500 md:mt-24  hover:shadow-red-800 transition-all duration-500 ease-in-out transform hover:scale-105 hover:-translate-y-2 hover:rotate-1">
